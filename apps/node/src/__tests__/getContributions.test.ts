...
describe("getContributions", () => {
    ...
    it("should return a max value only", () => {
        const input = "At the time a Participant enrolls in the Plan pursuant to Section 5 of the Plan, he or she will elect to have Contributions (in the form of payroll deductions or otherwise, to the extent permitted by the Administrator) made on each pay day during the Offering Period in an amount not exceeding fifteen percent (15%) of the Compensation, which he or she receives on each pay day during the Offering Period (for illustrative purposes, should a pay day occur on an Exercise Date, a Participant will have any payroll deductions made on such day applied to his or her account under the then-current Purchase Period or Offering Period).";
        const expected = {
            min: [],
            max: ["15%"],
        }
